...
import dmlp_data1 from "../../files/mlp_4uni_mf/mlp_data1.csv";
import dmlp_data2 from "../../files/mlp_4uni_mf/mlp_data2.csv";
import dmlp_data3 from "../../files/mlp_4uni_mf/mlp_data3.csv";
import dmlp_data4 from "../../files/mlp_4uni_mf/mlp_data4.csv";
import dmlp_data5 from "../../files/mlp_4uni_mf/mlp_data5.csv";
...
class Graficos6 extends React.Component {
  ...
  render() {
    ...
    return (<Card>
      <CardHeader
        title="MLP 4UNI MF"
        subheader="Escolha os parametros para ver alterações no gráfico"
      />
      <CardContent>
...
export default withStyles(styles, { withTheme: true })(Graficos6);
